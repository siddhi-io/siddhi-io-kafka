 ...
 */
public class KafkaReplayConsumerThread implements Runnable {
    ...
    KafkaReplayConsumerThread(SourceEventListener sourceEventListener, String[] topics, String[] partitions,
