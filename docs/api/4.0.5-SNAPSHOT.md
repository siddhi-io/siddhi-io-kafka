...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">This specifies the list of Kafka servers to which the Kafka source must listen. This list should beprovided as a set of comma-separated values.<br>e.g., <code>127.0.0.1:9092,127.0.0.1:9093</code></td>
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">bootstrap.servers</td>
        <td style="vertical-align: top; word-wrap: break-word"> This parameter specifies the list of Kafka servers to which the Kafka sink must publish events. This list should be provided as a set of comma separated values. e.g., <code>127.0.0.1:9092,127.0.0.1:9093</code>.</td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">STRING</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">No</td>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">The partition number for the given topic. Only one partition ID can be defined. If no value is specified for this parameter, the Kafka sink publishes to the default partition of the topic</td>
        <td style="vertical-align: top">0</td>
